            ...
            <div class="row">
                <div class="col s12 m12">
                    <div class="card-panel white">
                        ...
                        <p>Количество проголосовавших ${poll.statistics.countVoter}</p>
                        <p>Количество мнений выражено ${poll.statistics.countOpinions}</p>
                        <p><a href="${path}/poll/result?pollId=${poll.id}">Подробно</a></p>
